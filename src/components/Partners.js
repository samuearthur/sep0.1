              ...
              <div className="partners-items row">
                  ...
                  <div className="partners-item">
                    <div className="image">
                      <a target="_blank" href="https://www.envato.com/">
                        <img src="assets/images/brand_logo_03_1.png" alt="#1" />
                      </a>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="partners-item">
                    <div className="image">
                      <a target="_blank" href="https://www.envato.com/">
                        <img src="assets/images/brand_logo_08_1.png" alt="#2" />
                      </a>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="partners-item">
                    <div className="image">
                      <a target="_blank" href="https://www.envato.com/">
                        <img src="assets/images/brand_logo_06_1.png" alt="#3" />
                      </a>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="partners-item">
                    <div className="image">
                      <a target="_blank" href="https://www.envato.com/">
                        <img src="assets/images/brand_logo_05_1.png" alt="#4" />
                      </a>
                    </div>
                  </div>
                </div>
