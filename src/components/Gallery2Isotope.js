    ...
    <Fragment>
      ...
      <div className="section section-inner m-works">
        <div className="container">
          ...
          {/* works items */}
          <div className="works-items row classic column-2-offset portfolio-infinite-scrolling hide_title hide_category hide_description">
...
export default Gallery2Isotope;
